...
const ReviewElectricity = () => {
  ...
  const biller = params.biller || 'Ikeja Electricity';
  const accountType = params.accountType || 'Prepaid';
  const meterNumber = params.meterNumber || '';
  const amount = params.amount || '5000.00';
  const nameOnAccount = 'ADEMOLA ADENIYI'; // This would typically come from API
  ...
  const transactionRows = [
    ...
    { label: 'Name on account', value: nameOnAccount },
